...
'      Select Case v1
'      Case "M", "m": m0 = 0 ' ÐiêÒm khõÒi hành
'      Case "A", "a": m0 = v2 ' VoÌng cung
'      Case "V", "v": m0 = v2 ' ÐýõÌng doòc
'      Case "H", "h": m0 = v2 ' ÐýõÌng ngang
'      Case "L", "l": m0 = v2 ' Phân ðoaòn
'      Case "C", "c", "Q", "q": If IsNumeric(v2) Then m0 = v2: ' ÐýõÌng cong
'      Case "Z", "z": m0 = v0: ' Ðóng
'      End Select
'n:
'    Next
